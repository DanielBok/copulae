...
.. math::
   :nowrap:
    ...
    \begin{align*}
        C(\textbf{u}) = \psi(\psi^{-1}(u_1), \dots, \psi(d_d)) \quad \textbf{u} \in [0, 1]^d
    \end{align*}
...
1. Is continous and decreasing. This means that it maps a value :math:`x` from :math:`[0, \infty] \rightarrow [0, 1]`.
