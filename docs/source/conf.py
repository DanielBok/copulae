...
html_theme_options = {
    'github_url': 'https://github.com/danielbok/copulae',
    'google_analytics_id': 'UA-137019616-1',
...
man_pages = [
    (master_doc, 'copulae', 'Copulae Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Copulae', 'Copulae Documentation',
     author, 'Copulae', 'One line description of project.',
     'Miscellaneous'),
]
